...
## ES的分词策略有哪些？
1. 标准分词器（Standard Analyzer）：默认分词器，适用于大多数文本  
2. 简单分词器（Simple Analyzer）：按非字母字符分词，适用于英文文本  
3. 空格分词器（Whitespace Analyzer）：按空格分词，保留大小写  
4. 中文分词器（IK Analyzer）：适用于中文文本，支持细粒度和智能分词